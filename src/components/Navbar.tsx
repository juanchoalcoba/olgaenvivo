    ...
    <header className="w-full bg-white/60 backdrop-blur-md border-b border-gray-200 fixed top-0 left-0 z-40">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="#contacto" className="hidden md:inline-block text-sm font-medium px-4 py-2 rounded-lg bg-blue-900 text-white hover:bg-pink-700">Contacto</a>
      ...
      <div className={`md:hidden transition-max-h duration-300 overflow-hidden ${open ? 'max-h-96' : 'max-h-0'}`}>
        <div className="px-4 pt-2 pb-4 space-y-1">
          ...
          <a href="#contacto" className="block px-3 py-2 rounded-md text-base font-medium text-white bg-pink-600 text-center">Contacto</a>
        </div>
      </div>
    </header>
  );
